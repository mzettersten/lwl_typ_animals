...
#save frame rate table
write_csv(fr_table,here::here("..","..","data","processed_data","CATegories_exp2_frame_rate_table.csv"))
```

Integrate the data with the frame rate information

```{r}
#read in frame rate table
fr_table <- read_csv(here::here("..","..","data","processed_data","CATegories_exp2_frame_rate_table.csv"))
...
d <- d %>%
  mutate(
    ...
    #ensure time starts at zero on first frame by subtracting 1 from frame_counter
    corrected_time = (frame_counter-1) * ms_per_frame,
...
cols_to_remove <- c(
  "audio_time",
  "audio_lag_vs_video",
  "audio_lag_vs_display_images",
  "audio_lag_vs_start_timer",
  "video_end_minus_audio_end"
)
